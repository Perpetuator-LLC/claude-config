...
5. **End with a CONCISE paste-ready kickoff block** — the prompt itself stays short and just references the doc: `Read: <journal path> → "<your addendum heading>"` + one line of goal + one line of constraints (repo, branch, gates). All detail lives in the addendum, not the prompt.
